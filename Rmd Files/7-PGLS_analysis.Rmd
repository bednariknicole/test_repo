...
First we check if data for eye size and eye investment across ecological states is normally distributed. pglsres.cdmass is the variable for the cornea diameter ~ mass residuals.
...
leveneTest(pglsres.cdmass.all$pglsres.cdmass ~ pglsres.cdmass.all$Adult_Habitat)
```
