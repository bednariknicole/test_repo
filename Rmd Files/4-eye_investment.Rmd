...
#ladderize tree
tree_cdmass <- ladderize(tree_cdmass)

#check that phylogeny and data match exactly
name.check(tree_cdmass, sal.bars.cdmass)

#resort trait dataset to the order of tree tip labels
sal.bars.cdmass <- sal.bars.cdmass[tree_cdmass$tip.label, ] 
...
plotTree.wBars(tree_cdmass, abscor, 
               scale = 0.04, 
               tip.labels = TRUE, 
               offset = 0.35,
               ftype = "bi",
...
plotTree.wBars(tree_cdmass, inv.mass, 
               scale = 0.7, 
               tip.labels = FALSE, 
               col = tipcols.hab,
               plot = FALSE, 
