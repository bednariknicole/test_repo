...
changes <- data.frame(read.csv("../Data/Thomas et al. 2020/Data/phylosubs.csv", header=TRUE))
...
tree_orig <- read.tree(file = "../Data/Thomas et al. 2020/Data/Chronogram_309sp.txt") #reads tree
...
#Export final tree
write.nexus(frog.tree, file = "../Data/Thomas et al. 2020/Data/frog-tree.nex")
```
