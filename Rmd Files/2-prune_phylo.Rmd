...
author: "Nicole Bednarik and Katie Thomas"
date: 23 Jan 2025
output:
  html_document:
    code_fold: show
...
## Produce tree matching species with eye size data

# Make list of taxa to drop (in tree but not in data set)
...
name.check(tree.pruned, tip_species)

## Produce tree that includes eye size data species plus two blind species (no eyes)
...
# Check that phylogeny tips and data match exactly (if they match will return "OK")
name.check(tree.pruned_blind, tip_species_blind)
```
