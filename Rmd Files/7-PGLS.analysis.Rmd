...
rownames(sal.res) <- sal.res$Genus_Species
...
name.check(phy = caudatatree, data = sal.res)
...
drops2 <- name.check(phy = caudatatree, data = sal.res)
...
tree.pupil <- drop.tip(caudatatree, drops$tree_not_data)
...
sal.comp.1 <- comparative.data(phy = tree.act, data = sal.res.new, 
                            names.col = Genus_Species, vcv = TRUE, 
                            na.omit = FALSE, warn.dropped = TRUE)
sal.comp.2 <- comparative.data(phy = tree.pupil, data = sal.res, 
                            names.col = Genus_Species, vcv = TRUE, 
                            na.omit = FALSE, warn.dropped = TRUE)
