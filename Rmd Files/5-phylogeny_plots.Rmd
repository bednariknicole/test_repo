...
Eurycea_rathbuni <- data.frame(X.1 = 156, Genus_Species = "Eurycea_rathbuni", X = 159, eye_av = NA, cor_av = NA, svl_av = 4.93, rootmass_av = 2.11, n = 3, Order = "Caudata", Suborder = "Salamandroidea", Family = "Plethodontidae", Genus = "Eurycea", Species = "rathbuni", Gill_Presence = "yes", Activity_Period = NA, Adult_Habitat = "aquatic", Development = "paedomorphic", Life_History = "free-living", Larval_Habitat = "lentic water", pglsres.cdmass = NA)
Proteus_anguinus <- data.frame(X.1 = 157, Genus_Species = "Proteus_anguinus", X = 160, eye_av = NA, cor_av = NA, svl_av = 175.37, rootmass_av = 26.33, n = 3, Order = "Caudata", Suborder = "Salamandroidea", Family = "Proteidae", Genus = "Proteus", Species = "anguinus", Gill_Presence = "yes", Activity_Period = "nocturnal", Adult_Habitat = "aquatic", Development = "paedormophic", Life_History = "free-living", Larval_Habitat = "lentic water", pglsres.cdmass = NA)
Eurycea_rathbuni <- data.frame(tip = "Eurycea_rathbuni", labels = "Eurycea rathbuni")
Proteus_anguinus <- data.frame(tip = "Proteus_anguinus", labels = "Proteus anguinus")

# Step 3: Add the new rows to the existing dataframe
pglsres.cdmass.all.exp.blind <- rbind(pglsres.cdmass.all.exp, Eurycea_rathbuni, Proteus_anguinus)
labs <- rbind(labs, Eurycea_rathbuni, Proteus_anguinus)
```
...
# Filter out species with NA for activity period
sal.phy.act <- sal.phy %>% filter(!is.na(Activity_Period))
...
# Make a second plot next to the phylogeny (bars for cornea diameter)
p2_act <- facet_plot(p_act, panel="Cornea diameter (mm)", data=sal.phy.act, geom=geom_segment, aes(x=0, xend=cor_av, y=y, yend=y, color = Activity_Period), size = 3, alpha = 0.7) 

# Make a third plot next to the first two (bars for relative cornea size)
p3_act <- facet_plot(p2_act, panel='Relative cornea size', data=sal.phy.act, geom=geom_segment, aes(x=1, xend=pglsres.cdmass, y=y, yend=y, color = Activity_Period), size=3, alpha = 0.7) +
